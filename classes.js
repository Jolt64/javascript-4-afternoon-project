...
const employee1 = new Employee('Steve', 'Johnson', 'johnson@things.com', 52);
const employee2 = new Employee('Jack', 'Johnson', 'thingsJack@things.com', 34);
...
class Manager extends Employee {
  ...
  hire(obj) {this.reports.push(obj)}
...
class ProgressiveManager extends Manager {
  ...
  hire(employee) {
    ...
    if (num === 0) this.title = 'Not a manager'
    else if (num <= 3) this.title = 'Barely Manager'
    else if (num <= 10) this.title = 'Mostly Manager'
    else if (num <= 50) this.title = 'Manager'
    else if (num <= 100) this.title = 'Manager Plus'
    else if (num > 100) this.title = 'Bestest Manager'
  }
  fire(index) {
...
// const proManager1 = new ProgressiveManager();
// proManager1.hire(employee1)
...
const widgetMaker1 = new Machine();
widgetMaker1.makeWidgets(10)
widgetMaker1.makeWidgets(50)
console.log(widgetMaker1);

const widgetMaker2 = new Machine();
widgetMaker2.makeWidgets(20)
widgetMaker2.makeWidgets(100)
widgetMaker2.fixMachine()
widgetMaker2.reboot()
console.log(widgetMaker2);
